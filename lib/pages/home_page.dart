...
class _HomePageState extends State<HomePage> {
  final List<Map<String, String>> customiseVideoUrls = [
    {
      ...
      "description":
          "Our love story is just like a modern-day fairytale! 🌍❤️ From the snow-covered streets of Canada to the vibrant lanes of India.",
    ...
    },
    {
      ...
      "video":
          "assets/home_page_assets/Customise_order2/Siddharth_weds_Maithili1.mp4",
    },
    {
      "title": "Kanchan Priya weds Drew",
      "description":
          "Our love story began in the heart of Bangalore, where fate brought a USA groom and an Indian bride together in the most magical way. 🇺🇸❤️🇮🇳 Amidst the vibrant culture, bustling streets, and unforgettable moments, we found each other.",
      "image": "assets/home_page_assets/Customise_order3/image.png",
      "video":
          "assets/home_page_assets/Customise_order3/Kanchan_Priya_weds_Drew1.mp4",
    },
  ];
  ...
  Widget _buildCustomizedInvites(
      String image, String video, String title, String description) {
    return Padding(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.poppins(
                    textStyle:
                        TextStyle(color: Color(0xffD9D9D9), fontSize: 45)),
              ),
            ),
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.roboto(
                    textStyle:
                        TextStyle(color: Color(0xff6D6D6D), fontSize: 32)),
              ),
            ),
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.manrope(
                    textStyle:
                        TextStyle(color: Color(0xff6D6D6D), fontSize: 22)),
              ),
            ),
            Padding(
                  ...
                  child: Align(
                    ...
                    child: GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        mainAxisSpacing: 2,
                        childAspectRatio:
                            0.85, // Adjust aspect ratio to control item sizing
                      ),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return VideoReviewCard(
                            image: reviewVideoUrls[index]["image"]!,
                            videoUrl: reviewVideoUrls[index]["video"]!);
                      },
                    ),
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _buildCustomizedInvites(
                            customiseVideoUrls[index]["image"]!,
                            customiseVideoUrls[index]["video"]!,
                            customiseVideoUrls[index]["title"]!,
                            customiseVideoUrls[index]["description"]!);
                      },
                    ),
                  ),
                ),
